...
export default function Home() {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      socket.off('messageSentSuccess', handleMessageSent);//kjiuhiygfytdcfyvgbhjnmkbhgvfycvgucfgbhfyctgyty
    };
  }, [socket]);
      ...
      <div className="relative flex h-[95vh] w-full max-w-6xl overflow-hidden rounded-xl bg-[#1a1a1a] text-white shadow-lg">
        <div className="hidden md:flex flex-col w-20 h-full bg-[#0d0d0d] border-r border-gray-800">
          ...
          <div className="mt-auto mb-6 flex flex-col items-center space-y-6 text-gray-400 text-lg">
            <button onClick={() => setActivePage('settings')} className="hover:text-white cursor-pointer" title="Settings">
        ...
        <div className="fixed bottom-0 left-0 right-0 z-50 bg-[#0d0d0d] border-t border-gray-800 flex justify-around items-center py-2 md:hidden">
          <button onClick={() => setActivePage('chat')} className="flex flex-col items-center text-gray-400 hover:text-white" title="Chats">
            <FontAwesomeIcon icon={faPaperPlane} className="text-xl" />
            <span className="text-xs">Chats</span>
          </button>
          <button onClick={() => setActivePage('groups')} className="flex flex-col items-center text-gray-400 hover:text-white" title="Groups">
            <FontAwesomeIcon icon={faVideo} className="text-xl" />
            <span className="text-xs">Groups</span>
          </button>
          <button onClick={() => setActivePage('calls')} className="flex flex-col items-center text-gray-400 hover:text-white" title="Calls">
            <FontAwesomeIcon icon={faPhone} className="text-xl" />
            <span className="text-xs">Calls</span>
          </button>
          <button onClick={() => setActivePage('settings')} className="flex flex-col items-center text-gray-400 hover:text-white" title="Settings">
